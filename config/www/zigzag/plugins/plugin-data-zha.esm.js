...
class Connection {
    ...
    async _handleClose(ev) {
        ...
        this.commands.forEach((info) => {
            ...
            if (!("subscribe" in info)) {
                info.reject(error$2(ERR_CONNECTION_LOST, "Connection lost"));
            }
        });
...
const PluginConfigSchema = PluginConfigBaseSchema.extend({
    connection: cjs["instanceof"](Connection),
});
...
//# sourceMappingURL=plugin-data-zha.esm.js.map
