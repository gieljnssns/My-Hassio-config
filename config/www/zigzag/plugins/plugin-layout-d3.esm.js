...
class LRUCache$1 {
  ...
  prune () {
    this[CACHE$1].forEach((value, key) => get$2(this, key, false));
  }
}
...
var LayoutPluginID;
(function (LayoutPluginID) {
    LayoutPluginID["D3"] = "d3";
})(LayoutPluginID || (LayoutPluginID = {}));
class PluginLayoutBase extends PluginBase {
    constructor() {
        super();
...
class LayoutPlugin extends PluginLayoutBase {
    constructor(config) {
        super();
        this.fqpi = `${this.id}-d3`;
        this._links = [];
        this._nodes = [];
        this.config = config;
        this._engine = simulation()
    ...
    injectLinks(links) {
        this._links = [...links];
        this._engine.force(`link`, link(this._links).distance(300));
    }
    injectNodes(nodes) {
        this._nodes = [...nodes];
        this._engine
...
export { LayoutPlugin, PluginConfigSchema, createPlugin };
//# sourceMappingURL=plugin-layout-d3.esm.js.map
