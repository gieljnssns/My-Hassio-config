...
const PluginConfigSchema = PluginConfigBaseSchema.merge(cjs.object({
    filePath: cjs.string().nonempty(),
    count: cjs.number().positive(),
}));
...
class DataPlugin extends PluginDataBase {
    ...
    async fetchData() {
        ...
        try {
            ...
            DataPlugin._generateMoreDevices(this.config.count - zhaDevices.result.length, zhaDevices.result);
    ...
    static _generateMoreDevices(noOfDevicesToAdd, zhaDevices) {
...
//# sourceMappingURL=plugin-data-gen.esm.js.map
