import{cU as e,_ as a,n as i,b as t,t as r,a as o,cV as s,cT as n,cW as d,cX as c,x as l,cY as h,l as g,cZ as m,e as v,c_ as u,r as p,c$ as C,d0 as I,d1 as _,d2 as M,d3 as w,d4 as f}from"./card-44020f7c.js";import{u as b,i as y}from"./media-layout-4879c306.js";import{p as A,d as j,M as D,A as $,a as S,b as L}from"./media-c025c6e2.js";class E{constructor(e){this._inBackground=!1,this._lastMediaLoadedInfo=null,this._handleMediaLoaded=e=>{this._lastMediaLoadedInfo={source:e.composedPath()[0],mediaLoadedInfo:e.detail},this._inBackground&&e.stopPropagation()},this._host=e,e.addController(this),this._intersectionObserver=new IntersectionObserver(this._intersectionHandler.bind(this))}hostConnected(){this._intersectionObserver.observe(this._host),this._host.addEventListener("advanced-camera-card:media:loaded",this._handleMediaLoaded)}hostDisconnected(){this._intersectionObserver.disconnect(),this._host.removeEventListener("advanced-camera-card:media:loaded",this._handleMediaLoaded)}isInBackground(){return this._inBackground}_intersectionHandler(a){const i=this._inBackground;this._inBackground=!a.some((e=>e.isIntersecting)),!this._inBackground&&this._lastMediaLoadedInfo&&e(this._lastMediaLoadedInfo.source,this._lastMediaLoadedInfo.mediaLoadedInfo),i!==this._inBackground&&this._host.requestUpdate()}}let T=class extends o{constructor(){super(...arguments),this.load=!1,this.label="",this._isVideoMediaLoaded=!1,this._hasProviderError=!1,this._showStreamTroubleshooting=!1,this._refProvider=s(),this._importPromises=[]}async play(){await this.updateComplete,await(this._refProvider.value?.updateComplete),await A(this,this._refProvider.value)}async pause(){await this.updateComplete,await(this._refProvider.value?.updateComplete),await(this._refProvider.value?.pause())}async mute(){await this.updateComplete,await(this._refProvider.value?.updateComplete),await(this._refProvider.value?.mute())}async unmute(){await this.updateComplete,await(this._refProvider.value?.updateComplete),await(this._refProvider.value?.unmute())}isMuted(){return this._refProvider.value?.isMuted()??!0}async seek(e){await this.updateComplete,await(this._refProvider.value?.updateComplete),await(this._refProvider.value?.seek(e))}async setControls(e){await this.updateComplete,await(this._refProvider.value?.updateComplete),await(this._refProvider.value?.setControls(e))}isPaused(){return this._refProvider.value?.isPaused()??!0}async getScreenshotURL(){return await this.updateComplete,await(this._refProvider.value?.updateComplete),await(this._refProvider.value?.getScreenshotURL())??null}getFullscreenElement(){return this._refProvider.value?.getFullscreenElement()??null}_getResolvedProvider(){return"auto"===this.cameraConfig?.live_provider?this.cameraConfig?.webrtc_card?.entity||this.cameraConfig?.webrtc_card?.url?"webrtc-card":this.cameraConfig?.camera_entity?"ha":this.cameraConfig?.frigate.camera_name?"jsmpeg":n.cameras.live_provider:this.cameraConfig?.live_provider||"image"}_shouldShowImageDuringLoading(){return!(this._isVideoMediaLoaded||!this.cameraConfig?.camera_entity||!this.hass||!this.liveConfig?.show_image_during_load||this._showStreamTroubleshooting||this._hasProviderError)}disconnectedCallback(){this._isVideoMediaLoaded=!1}_videoMediaShowHandler(){this._isVideoMediaLoaded=!0,this._showStreamTroubleshooting=!1}_providerErrorHandler(){this._hasProviderError=!0}willUpdate(e){if(e.has("load")&&(this.load||(this._isVideoMediaLoaded=!1,d(this))),e.has("liveConfig")&&(this.liveConfig?.show_image_during_load&&this._importPromises.push(import("./image-21b062dd.js")),this.liveConfig?.zoomable&&this._importPromises.push(import("./zoomer-4650e197.js"))),e.has("cameraConfig")){const e=this._getResolvedProvider();"jsmpeg"===e?this._importPromises.push(import("./jsmpeg-a7c09fe9.js")):"ha"===e?this._importPromises.push(import("./ha-b1c0b341.js")):"webrtc-card"===e?this._importPromises.push(import("./webrtc-card-285d271b.js")):"image"===e?this._importPromises.push(import("./image-21b062dd.js")):"go2rtc"===e&&this._importPromises.push(import("./index-64c2b9c5.js")),b(this,this.cameraConfig?.dimensions?.layout),this.style.aspectRatio=c({ratio:this.cameraConfig?.dimensions?.aspect_ratio})}}async getUpdateComplete(){const e=await super.getUpdateComplete();return await Promise.all(this._importPromises),this._importPromises=[],e}_useZoomIfRequired(e){return this.liveConfig?.zoomable?l` <advanced-camera-card-zoomer
    ...
    `}_getSubstreamCameraID(e,a){return a?.context?.live?.overrides?.get(e)??e}_getCameraNeighbors(){const e=this.cameraManager?[...this.cameraManager?.getStore().getCameraIDsWithCapability("live")]:[],a=this.viewManagerEpoch?.manager.getView();if(this.viewFilterCameraID||e.length<=1||!a||!this.hass)return{};const i=this.viewFilterCameraID??a.camera,t=e.indexOf(i);if(t<0)return{};const r=e[t>0?t-1:e.length-1],o=e[t+1<e.length?t+1:0];return{previous:{id:r,metadata:r?this.cameraManager?.getCameraMetadata(this._getSubstreamCameraID(r,a)):null},next:{id:o,metadata:o?this.cameraManager?.getCameraMetadata(this._getSubstreamCameraID(o,a)):null}}}_renderNextPrevious(e,a){const i=I(this),t="ltr"===i&&"left"===e||"rtl"===i&&"right"===e?a?.previous:a?.next;return l`<advanced-camera-card-next-previous-control
      ...
      ?disabled=${!t}
      @click=${e=>{this._setViewCameraID(t?.id),_(e)}}
    >
    ...
    `}_setMediaTarget(){const e=this.viewManagerEpoch?.manager.getView(),a=this._getSelectedCameraIndex();this.viewFilterCameraID?this._mediaActionsController.setTarget(a,e?.camera===this.viewFilterCameraID):this._mediaActionsController.setTarget(a,!0)}updated(e){super.updated(e);let a=!1;!this._mediaActionsController.hasRoot()&&this._refCarousel.value&&(this._mediaActionsController.initialize(this._refCarousel.value),a=!0),(a||e.has("viewManagerEpoch"))&&this._setMediaTarget()}static get styles(){return p(":host {\n  display: block;\n  --video-max-height: none;\n}\n\n:host(:not([grid-id])) {\n  height: 100%;\n}\n\n:host([unselected]) advanced-camera-card-carousel {\n  pointer-events: none;\n}\n\n.embla__slide {\n  display: flex;\n  justify-content: center;\n  height: 100%;\n  flex: 0 0 100%;\n}")}};a([i({attribute:!1})],k.prototype,"hass",void 0),a([i({attribute:!1})],k.prototype,"viewManagerEpoch",void 0),a([i({attribute:!1})],k.prototype,"liveConfig",void 0),a([i({attribute:!1})],k.prototype,"cardWideConfig",void 0),a([i({attribute:!1})],k.prototype,"cameraManager",void 0),a([i({attribute:!1})],k.prototype,"microphoneState",void 0),a([i({attribute:!1})],k.prototype,"viewFilterCameraID",void 0),a([t()],k.prototype,"_mediaHasLoaded",void 0),k=a([r("advanced-camera-card-live-carousel")],k);let z=class extends o{_renderCarousel(e){const a=this.viewManagerEpoch?.manager.getView(),i=e??a?.camera;return l`
    ...
    `:this._renderCarousel()}static get styles(){return p(":host {\n  width: 100%;\n  height: 100%;\n  display: block;\n}\n\n@keyframes warning-pulse {\n  0% {\n    border: solid 2px var(--advanced-camera-card-triggered-color-1, rgba(0, 0, 0, 0));\n  }\n  50% {\n    border: solid 2px var(--advanced-camera-card-triggered-color-2, var(--warning-color));\n  }\n  100% {\n    border: solid 2px var(--advanced-camera-card-triggered-color-1, rgba(0, 0, 0, 0));\n  }\n}\nadvanced-camera-card-live-carousel[triggered] {\n  animation: warning-pulse 5s infinite;\n}\n\nadvanced-camera-card-live-carousel[selected] {\n  --advanced-camera-card-triggered-color-1: var(--primary-color);\n}")}};a([i({attribute:!1})],z.prototype,"hass",void 0),a([i({attribute:!1})],z.prototype,"viewManagerEpoch",void 0),a([i({attribute:!1})],z.prototype,"liveConfig",void 0),a([i({attribute:!1})],z.prototype,"cardWideConfig",void 0),a([i({attribute:!1})],z.prototype,"cameraManager",void 0),a([i({attribute:!1})],z.prototype,"microphoneState",void 0),a([i({attribute:!1})],z.prototype,"triggeredCameraIDs",void 0),z=a([r("advanced-camera-card-live-grid")],z);let P=class extends o{constructor(){super(...arguments),this._controller=new E(this)}render(){if(this.hass&&this.cameraManager)return l`
    ...
    `}static get styles(){return p(f)}};a([i({attribute:!1})],P.prototype,"hass",void 0),a([i({attribute:!1})],P.prototype,"viewManagerEpoch",void 0),a([i({attribute:!1})],P.prototype,"liveConfig",void 0),a([i({attribute:!1})],P.prototype,"cameraManager",void 0),a([i({attribute:!1})],P.prototype,"cardWideConfig",void 0),a([i({attribute:!1})],P.prototype,"microphoneState",void 0),a([i({attribute:!1})],P.prototype,"triggeredCameraIDs",void 0),P=a([r("advanced-camera-card-live")],P);export{P as AdvancedCameraCardLive};
