import{i as e,s as i,_ as t,n,t as a,a as s,x as o,e as r,l,r as c,b as d,c as u,d as m,p as h,f as _,g,h as b,j as p,k as v,C as f,m as $,o as y,q as w,u as S,v as x,w as M,y as I,z as k,A as O,B as C,D as z,E as A,F as N,G as T,H as B,I as E,J as P,K as H,L,M as V,N as K,O as U,P as j,S as q,Q as R,R as D,Z as F,T as G,U as J,V as Q,W,X,Y,$ as Z,a0 as ee,a1 as ie,a2 as te,a3 as ne,a4 as ae,a5 as se,a6 as oe,a7 as re,a8 as le,a9 as ce,aa as de,ab as ue,ac as me,ad as he,ae as _e,af as ge,ag as be,ah as pe,ai as ve,aj as fe,ak as $e,al as ye,am as we,an as Se,ao as xe,ap as Me,aq as Ie,ar as ke,as as Oe,at as Ce,au as ze,av as Ae,aw as Ne,ax as Te,ay as Be,az as Ee,aA as Pe,aB as He,aC as Le,aD as Ve,aE as Ke,aF as Ue,aG as je,aH as qe,aI as Re,aJ as De,aK as Fe,aL as Ge,aM as Je,aN as Qe,aO as We,aP as Xe,aQ as Ye,aR as Ze,aS as ei,aT as ii,aU as ti,aV as ni,aW as ai,aX as si,aY as oi,aZ as ri,a_ as li,a$ as ci,b0 as di,b1 as ui,b2 as mi,b3 as hi,b4 as _i,b5 as gi,b6 as bi,b7 as pi,b8 as vi,b9 as fi,ba as $i,bb as yi,bc as wi,bd as Si,be as xi,bf as Mi,bg as Ii,bh as ki,bi as Oi,bj as Ci,bk as zi,bl as Ai,bm as Ni,bn as Ti,bo as Bi,bp as Ei,bq as Pi,br as Hi,bs as Li,bt as Vi,bu as Ki,bv as Ui,bw as ji,bx as qi,by as Ri,bz as Di,bA as Fi,bB as Gi,bC as Ji,bD as Qi,bE as Wi,bF as Xi,bG as Yi,bH as Zi,bI as et,bJ as it,bK as tt,bL as nt,bM as at,bN as st,bO as ot,bP as rt,bQ as lt,bR as ct,bS as dt,bT as ut,bU as mt,bV as ht,bW as _t,bX as gt,bY as bt,bZ as pt,b_ as vt,b$ as ft,c0 as $t,c1 as yt,c2 as wt,c3 as St,c4 as xt,c5 as Mt,c6 as It,c7 as kt,c8 as Ot,c9 as Ct,ca as zt,cb as At,cc as Nt,cd as Tt,ce as Bt,cf as Et,cg as Pt,ch as Ht,ci as Lt,cj as Vt,ck as Kt,cl as Ut,cm as jt,cn as qt,co as Rt,cp as Dt,cq as Ft,cr as Gt,cs as Jt,ct as Qt,cu as Wt,cv as Xt,cw as Yt,cx as Zt,cy as en,cz as tn,cA as nn,cB as an,cC as sn,cD as on,cE as rn,cF as ln,cG as cn,cH as dn,cI as un,cJ as mn,cK as hn,cL as _n,cM as gn,cN as bn,cO as pn,cP as vn,cQ as fn,cR as $n,cS as yn,cT as wn}from"./card-fb92bb2e.js";class Sn{constructor(e){this._assigning=!1,this._value=null,this._blurEventHandler=()=>{this._setAssigning(!1)},this._keydownEventHandler=e=>{e.key&&!["Control","Alt","Shift","Meta"].includes(e.key)&&(this.setValue({key:e.key,ctrl:e.ctrlKey,alt:e.altKey,shift:e.shiftKey,meta:e.metaKey}),this._setAssigning(!1))},this._host=e,this._host.addController(this)}setValue(i){e(i,this._value)||(this._value=i,this._host.requestUpdate(),this._host.dispatchEvent(new CustomEvent("value-changed",{detail:{value:this._value}})))}getValue(){return this._value}hasValue(){return!!this._value}isAssigning(){return this._assigning}toggleAssigning(){this._setAssigning(!this._assigning)}_setAssigning(e){this._assigning=e,i(this._host,this._assigning,"assigning"),this._assigning?this._host.addEventListener("keydown",this._keydownEventHandler):this._host.removeEventListener("keydown",this._keydownEventHandler),this._host.requestUpdate()}hostConnected(){this._host.addEventListener("blur",this._blurEventHandler)}hostDisconnected(){this._host.removeEventListener("blur",this._blurEventHandler)}}let xn=class extends s{constructor(){super(...arguments),this._controller=new Sn(this)}willUpdate(e){e.has("value")&&this._controller.setValue(this.value??null)}render(){if(!this.label)return;const e=e=>o`<div class="key">
    ...
    `}_renderMiniTimeline(e,i,t,n,a,s,r,c,d,u,m){return this._putInSubmenu(e,!0,"config.common.controls.timeline.editor_label","mdi:chart-gantt",o` ${this._renderOptionSelector(i,this._miniTimelineModes,{label:l("config.common.controls.timeline.mode")})}
      ${this._renderTimelineCoreControls(e,t,n,a,s,r,c,d,u,m)}`)}_renderViewDisplay(e,i,t,n,a){return this._putInSubmenu(e,!0,"config.common.display.editor_label","mdi:palette-swatch",o`
    ...
    `}_renderCamera(e,i,t,n){const a=[{value:"",label:""},{value:"auto",label:l("config.cameras.live_providers.auto")},{value:"ha",label:l("config.cameras.live_providers.ha")},{value:"image",label:l("config.cameras.live_providers.image")},{value:"jsmpeg",label:l("config.cameras.live_providers.jsmpeg")},{value:"go2rtc",label:l("config.cameras.live_providers.go2rtc")},{value:"webrtc-card",label:l("config.cameras.live_providers.webrtc-card")}],s=[];e.forEach(((e,t)=>{t!==i&&s.push({value:te(e),label:this._getEditorCameraTitle(t,e)})}));const c=e=>{if(this._config){const i=u(this._config);e(i)&&this._updateConfig(i)}},d={submenu:!0,selected:this._expandedMenus[Mn]===i};return o`
      <div class="${r(d)}">
        ...
        ${this._expandedMenus[Mn]===i?o` <div class="values">
              <div class="controls">
                <ha-icon-button
                  .label=${l("editor.move_up")}
                  .disabled=${n||!this._config||!Array.isArray(this._config.cameras)||i<=0}
                  @click=${()=>!n&&c((e=>!!(Array.isArray(e.cameras)&&i>0)&&(vt(e.cameras,i,i-1),this._openMenu(Mn,i-1),!0)))}
                >
                  <advanced-camera-card-icon
                ...
                <ha-icon-button
                  ...
                  @click=${()=>!n&&c((e=>!!(Array.isArray(e.cameras)&&i<e.cameras.length-1)&&(vt(e.cameras,i,i+1),this._openMenu(Mn,i+1),!0)))}
                >
                  <advanced-camera-card-icon
                ...
                <ha-icon-button
                  ...
                  .disabled=${n}
                  @click=${()=>{c((e=>!!Array.isArray(e.cameras)&&(e.cameras.splice(i,1),this._closeMenu(Mn),!0)))}}
                >
                  <advanced-camera-card-icon
              ...
              ${this._renderEntitySelector(ne(ft,i),"camera")}
              ${this._renderOptionSelector(ne($t,i),a)}
              ${this._renderStringInput(ne(yt,i))}
              ${this._renderIconSelector(ne(wt,i),{label:l("config.cameras.icon")})}
              ${this._renderStringInput(ne(St,i))}
              ${this._renderSwitch(ne(xt,i),this._defaults.cameras.always_error_if_entity_unavailable)}
              ${this._putInSubmenu("cameras.engine",!0,"config.cameras.engines.editor_label","mdi:engine",o`${this._putInSubmenu("cameras.frigate",i,"config.cameras.frigate.editor_label","frigate",o`
                    ...
                    ${this._renderOptionSelector(ne(Ot,i),[],{multiple:!0,label:l("config.cameras.frigate.zones")})}
                    ${this._renderStringInput(ne(Ct,i))}
                  `)}
                ${this._putInSubmenu("cameras.motioneye",i,"config.cameras.motioneye.editor_label","motioneye",o` ${this._renderStringInput(ne(zt,i))}
                ...
                ${this._putInSubmenu("cameras.reolink",i,"config.cameras.reolink.editor_label","reolink",o` ${this._renderStringInput(ne(Et,i))}
                  ${this._renderOptionSelector(ne(Pt,i),this._reolinkMediaResolution,{label:l("config.cameras.reolink.media_resolution.editor_label")})}`)}`)}
              ${this._putInSubmenu("cameras.live_provider",!0,"config.cameras.live_provider_options.editor_label","mdi:cctv",o` ${this._putInSubmenu("cameras.go2rtc",i,"config.cameras.go2rtc.editor_label","mdi:alpha-g-circle",o`${this._renderOptionSelector(ne(Ht,i),this._go2rtcModes,{multiple:!0,label:l("config.cameras.go2rtc.modes.editor_label")})}
                  ${this._renderStringInput(ne(Lt,i))}
                  ${this._renderStringInput(ne(Vt,i))} `)}
                ${this._putInSubmenu("cameras.image",!0,"config.cameras.image.editor_label","mdi:image",this._renderImageOptions(ne(Kt,i),ne(Ut,i),ne(jt,i),ne(qt,i),ne(Rt,i)))}
                ${this._putInSubmenu("cameras.webrtc_card",i,"config.cameras.webrtc_card.editor_label","mdi:webrtc",o`${this._renderEntitySelector(ne(Dt,i),"camera")}
                  ${this._renderStringInput(ne(Ft,i))}`)}`)}
              ${this._putInSubmenu("cameras.dependencies",i,"config.cameras.dependencies.editor_label","mdi:graph",o` ${this._renderSwitch(ne(Gt,i),this._defaults.cameras.dependencies.all_cameras)}
                ${this._renderOptionSelector(ne(Jt,i),s,{multiple:!0})}`)}
              ${this._putInSubmenu("cameras.triggers",i,"config.cameras.triggers.editor_label","mdi:magnify-scan",o`
                  ${this._renderSwitch(ne(Qt,i),this._defaults.cameras.triggers.occupancy)}
                  ${this._renderSwitch(ne(Wt,i),this._defaults.cameras.triggers.motion)}
                  ${this._renderOptionSelector(ne(Xt,i),t,{multiple:!0})}
                  ${this._renderOptionSelector(ne(Yt,i),this._triggersEvents,{multiple:!0,label:l("config.cameras.triggers.events.editor_label")})}
                `)}
              ${this._putInSubmenu("cameras.cast",i,"config.cameras.cast.editor_label","mdi:cast",o`
                  ${this._renderOptionSelector(ne(Zt,i),this._castMethods)}
                  ${this._renderStringInput(ne(en,i))}
                  ${this._renderStringInput(ne(tn,i))}
                `)}
              ${this._putInSubmenu("cameras.dimensions",i,"config.cameras.dimensions.editor_label","mdi:aspect-ratio",o`
                  ...
                  ${this._renderMediaLayout("cameras.dimensions.layout","config.cameras.dimensions.layout.editor_label",ne(an,i),ne(sn,i),ne(on,i),ne(rn,i),ne(ln,i),ne(cn,i),ne(dn,i),ne(un,i),ne(mn,i),ne(hn,i))}
                `)}
              ${this._putInSubmenu("cameras.capabilities",i,"config.cameras.capabilities.editor_label","mdi:cog-stop",o`
                  ${this._renderOptionSelector(ne(_n,i),this._capabilities,{multiple:!0})}
                  ${this._renderOptionSelector(ne(gn,i),this._capabilities,{multiple:!0})}
                `)}
              ${this._putInSubmenu("cameras.proxy",i,"config.cameras.proxy.editor_label","mdi:arrow-decision",o`
                  ${this._renderOptionSelector(ne(bn,i),this._proxyMedia,{label:l("config.cameras.proxy.media.editor_label")})}
                  ${this._renderSwitch(ne(pn,i),this._defaults.cameras.proxy.dynamic)}
                  ${this._renderOptionSelector(ne(vn,i),this._proxySSLVerification,{label:l("config.cameras.proxy.ssl_verification.editor_label")})}
                  ${this._renderOptionSelector(ne(fn,i),this._proxySSLCiphers,{label:l("config.cameras.proxy.ssl_ciphers.editor_label")})}
                `)}
            </div>`:""}
      </div>
    ...
    `}_updateConfig(e){this._config=e,ae(this,"config-changed",{config:this._config})}render(){if(!this.hass||!this._config)return o``;const e=x(this.hass),i=b(this._config,$n)||[];return o`
      ...
      <div class="card-config">
        ...
        ${"cameras"===this._expandedMenus[In]?o`
              <div class="values">
        ...
        ${"profiles"===this._expandedMenus[In]?o` <div class="values">
        ...
        ${"status_bar"===this._expandedMenus[In]?o`
              <div class="values">
        ...
        ${"live"===this._expandedMenus[In]?o`
              <div class="values">
                ...
                ${this._putInSubmenu("live.controls",!0,"config.live.controls.editor_label","mdi:gamepad",o`
                    ...
                    ${this._renderMiniTimeline("live.controls.timeline",Je,Qe,We,Xe,Ye,Ze,ei,this._defaults.live.controls.timeline.show_recordings,this._defaults.live.controls.timeline.format["24h"],ii)}
                    ${this._putInSubmenu("live.controls.ptz",!0,"config.live.controls.ptz.editor_label","mdi:pan",o`
                        ${this._renderOptionSelector(ti,this._ptzModes)}
                        ${this._renderOptionSelector(ni,this._ptzPositions)}
                        ${this._renderOptionSelector(ai,this._ptzOrientations)}
                        ${this._renderSwitch(si,this._defaults.live.controls.ptz.hide_pan_tilt,{label:l("config.live.controls.ptz.hide_pan_tilt")})}
                        ${this._renderSwitch(oi,this._defaults.live.controls.ptz.hide_pan_tilt,{label:l("config.live.controls.ptz.hide_zoom")})}
                        ${this._renderSwitch(ri,this._defaults.live.controls.ptz.hide_home,{label:l("config.live.controls.ptz.hide_home")})}
                      `)}
                  `)}
                ${this._putInSubmenu("live.microphone",!0,"config.live.microphone.editor_label","mdi:microphone",o`
                    ${this._renderNumberInput(li)}
                    ${this._renderSwitch(ci,this._defaults.live.microphone.always_connected)}
                    ${this._renderNumberInput(di)}
                  `)}
              </div>
            `:""}
        ${this._renderOptionSetHeader("media_gallery")}
        ${"media_gallery"===this._expandedMenus[In]?o` <div class="values">
              ${this._renderThumbnailsControls("media_gallery.controls.thumbnails",ui,mi,hi,_i,gi,this._defaults.media_gallery.controls.thumbnails)}
              ${this._renderFilterControls("media_gallery.controls.filter",bi)}
            </div>`:""}
        ${this._renderOptionSetHeader("media_viewer")}
        ${"media_viewer"===this._expandedMenus[In]?o` <div class="values">
              ...
              ${this._renderOptionSelector($i,this._mediaActionPositiveConditions,{multiple:!0})}
              ${this._renderSwitch(yi,this._defaults.media_viewer.draggable)}
              ${this._renderSwitch(wi,this._defaults.media_viewer.zoomable)}
              ${this._renderSwitch(Si,this._defaults.media_viewer.lazy_load)}
              ${this._renderOptionSelector(xi,this._transitionEffects)}
              ${this._renderSwitch(Mi,this._defaults.media_viewer.snapshot_click_plays_clip)}
              ${this._renderViewDisplay("media_viewer.display",Ii,ki,Oi,Ci)}
              ${this._putInSubmenu("media_viewer.controls",!0,"config.media_viewer.controls.editor_label","mdi:gamepad",o`
                  ${this._renderSwitch(zi,this._defaults.media_viewer.controls.builtin,{label:l("config.common.controls.builtin")})}
                  ${this._renderNextPreviousControls("media_viewer.controls.next_previous",Ai,Ni,{allowThumbnails:!0})}
                  ${this._renderThumbnailsControls("media_viewer.controls.thumbnails",Ti,Bi,Ei,Pi,Hi,this._defaults.media_viewer.controls.thumbnails,{configPathMode:Li})}
                  ${this._renderMiniTimeline("media_viewer.controls.timeline",Vi,Ki,Ui,ji,qi,Ri,Di,this._defaults.media_viewer.controls.timeline.show_recordings,this._defaults.media_viewer.controls.timeline.format["24h"],Fi)}
                `)}
            </div>`:""}
        ${this._renderOptionSetHeader("image")}
        ${"image"===this._expandedMenus[In]?o` <div class="values">
              ${this._renderImageOptions(Gi,Ji,Qi,Wi,Xi)}
            </div>`:""}
        ${this._renderOptionSetHeader("timeline")}
        ${"timeline"===this._expandedMenus[In]?o` <div class="values">
              ${this._renderTimelineCoreControls("timeline.format",J,Q,W,X,Y,Yi,this._defaults.timeline.show_recordings,this._defaults.timeline.format["24h"])}
              ${this._renderThumbnailsControls("timeline.controls.thumbnails",Zi,et,it,tt,nt,this._defaults.timeline.controls.thumbnails,{configPathMode:at})}
            </div>`:""}
        ${this._renderOptionSetHeader("dimensions")}
        ${"dimensions"===this._expandedMenus[In]?o` <div class="values">
              ${this._renderOptionSelector(st,this._aspectRatioModes)}
              ${this._renderStringInput(ot)}
              ${this._renderStringInput(rt)}
            </div>`:""}
        ${this._renderOptionSetHeader("performance","low"===b(this._config,yn)?"warning":void 0)}
        ${"performance"===this._expandedMenus[In]?o` <div class="values">
              ${"low"===b(this._config,yn)?this._renderInfo(l("config.performance.warning")):o``}
              ${this._putInSubmenu("performance.features",!0,"config.performance.features.editor_label","mdi:feature-search",o`
                  ${this._renderSwitch(lt,this._defaults.performance.features.card_loading_indicator)}
                  ${this._renderSwitch(ct,this._defaults.performance.features.animated_progress_indicator)}
                  ${this._renderNumberInput(dt,{max:ut})}
                  ${this._renderNumberInput(mt,{min:1})}
                `)}
              ${this._putInSubmenu("performance.style",!0,"config.performance.style.editor_label","mdi:palette-swatch-variant",o`
                  ${this._renderSwitch(ht,this._defaults.performance.style.border_radius)}
                  ${this._renderSwitch(_t,this._defaults.performance.style.box_shadow)}
                `)}
            </div>`:""}
        ${this._renderOptionSetHeader("remote_control")}
        ${"remote_control"===this._expandedMenus[In]?o` <div class="values">
              ${this._putInSubmenu("remote_control.entities",!0,"config.remote_control.entities.editor_label","mdi:devices",o`
                  ${this._renderEntitySelector(gt,"input_select")}
                `)}
            </div>`:""}
        ${void 0!==this._config.overrides?o` ${this._renderOptionSetHeader("overrides")}
            ${"overrides"===this._expandedMenus[In]?o` <div class="values">
                  ${this._renderInfo(l("config.overrides.info"))}
                </div>`:""}`:o``}
      </div>
    `}_closeMenu(e){delete this._expandedMenus[e],this.requestUpdate()}_openMenu(e,i){this._expandedMenus[e]=i,this.requestUpdate()}_toggleMenu(e){if(e&&e.target){const i=e.target.domain,t=e.target.key;this._expandedMenus[i]===t?this._closeMenu(i):this._openMenu(i,t)}}_valueChangedHandler(e,i){if(!this._config||!this.hass)return;let t;if(i.detail&&void 0!==i.detail.value&&(t=i.detail.value,"string"==typeof t&&(t=t.trim())),b(this._config,e)===t)return;const n=u(this._config);""===t||void 0===t?bt(n,e):pt(n,e,t),this._updateConfig(n)}static get styles(){return c('ha-icon-button {\n  color: var(--advanced-camera-card-button-color);\n  background-color: var(--advanced-camera-card-button-background);\n  border-radius: 50%;\n  padding: 0px;\n  margin: 3px;\n  --ha-icon-display: block;\n  /* Buttons can always be clicked */\n  pointer-events: auto;\n}\n\n.option {\n  padding: 4px 4px;\n  cursor: pointer;\n}\n\n.option.option-overrides .title {\n  color: var(--warning-color);\n}\n\n.row {\n  display: flex;\n  margin-bottom: -14px;\n  pointer-events: none;\n}\n\n.title {\n  padding-left: 16px;\n  margin-top: -6px;\n  pointer-events: none;\n}\n\n.title.warning {\n  color: var(--warning-color);\n}\n\n.secondary {\n  padding-left: 40px;\n  color: var(--secondary-text-color);\n  pointer-events: none;\n}\n\n.values {\n  background: var(--secondary-background-color);\n  display: grid;\n}\n\n.values + .option,\n.submenu + .option {\n  margin-top: 10px;\n}\n\ndiv.upgrade {\n  width: auto;\n  border: 1px dotted var(--primary-color);\n  margin: 10px;\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n}\n\ndiv.upgrade span {\n  padding: 10px;\n}\n\n.submenu-header {\n  display: flex;\n  padding: 10px;\n  cursor: pointer;\n}\n\n.submenu.selected > .submenu-header {\n  background-color: var(--primary-color);\n  color: var(--primary-text-color);\n}\n\n.submenu-header * {\n  flex-basis: auto;\n  pointer-events: none;\n}\n\n.submenu-header .new-camera {\n  font-style: italic;\n}\n\n.submenu:not(.selected) > .submenu-header .new-camera {\n  color: var(--secondary-text-color, "black");\n}\n\n.submenu-header advanced-camera-card-icon {\n  margin-right: 15px;\n}\n\n.submenu.selected {\n  border: 1px solid var(--primary-color);\n}\n\n.submenu {\n  width: calc(100% - 20px);\n  margin-left: auto;\n  margin-right: auto;\n  margin-bottom: 10px;\n}\n\n.submenu:first-child,\n:not(.submenu) + .submenu {\n  margin-top: 10px;\n}\n\n.submenu .controls {\n  display: inline-block;\n  margin-left: auto;\n  margin-right: 0px;\n  margin-bottom: 5px;\n}\n\n.submenu .controls ha-icon-button {\n  --mdc-icon-button-size: 32px;\n  --mdc-icon-size: calc(var(--mdc-icon-button-size) / 2);\n}\n\nspan.info {\n  padding: 10px;\n}\n\nha-selector {\n  padding: 10px;\n  border: 1px solid var(--divider-color);\n}')}};t([n({attribute:!1})],On.prototype,"hass",void 0),t([d()],On.prototype,"_config",void 0),t([d()],On.prototype,"_defaults",void 0),t([d()],On.prototype,"_expandedMenus",void 0),On=t([a("advanced-camera-card-editor")],On);export{On as AdvancedCameraCardEditor};
