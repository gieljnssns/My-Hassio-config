import{_ as e,t as a,cY as t,x as s,d3 as r,dr as i,ds as d,dt as o,dq as l,r as n,eS as h,eH as c,cU as m,a as p,cV as y,cZ as u,n as _}from"./card-fb92bb2e.js";import{e as $,c as v}from"./image-player-05b33016.js";import{d as g}from"./dispatch-live-error-ca9edf89.js";import{V as f,h as b,M as w,m as P}from"./audio-936b74ad.js";customElements.whenDefined("ha-web-rtc-player").then((()=>{const c=customElements.get("ha-web-rtc-player");let m=class extends c{constructor(){super(...arguments),this._mediaPlayerController=new f(this,(()=>this._video),(()=>this.controls))}async getMediaPlayerController(){return this._mediaPlayerController}render(){return this._error?(g(this),t({type:"error",message:this._error,context:{entity_id:this.entityid}})):s`
        <video
          id="remote-stream"
