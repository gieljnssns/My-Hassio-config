import{cW as e,_ as a,n as i,b as t,t as r,a as o,cX as s,cV as n,cY as d,cZ as c,x as l,c_ as h,l as g,c$ as m,e as v,d0 as C,r as p,d1 as u,d2 as I,d3 as M,d4 as _,d5 as w,d6 as f}from"./card-149caa14.js";import{u as b,i as y}from"./media-layout-ab0cb07c.js";import{L as A,d as j,M as D,A as L,a as $}from"./dispatch-live-error-82b23126.js";class S{constructor(e){this._inBackground=!1,this._lastMediaLoadedInfo=null,this._handleMediaLoaded=e=>{this._lastMediaLoadedInfo={source:e.composedPath()[0],mediaLoadedInfo:e.detail},this._inBackground&&e.stopPropagation()},this._host=e,e.addController(this),this._intersectionObserver=new IntersectionObserver(this._intersectionHandler.bind(this))}hostConnected(){this._intersectionObserver.observe(this._host),this._host.addEventListener("advanced-camera-card:media:loaded",this._handleMediaLoaded)}hostDisconnected(){this._intersectionObserver.disconnect(),this._host.removeEventListener("advanced-camera-card:media:loaded",this._handleMediaLoaded)}isInBackground(){return this._inBackground}_intersectionHandler(a){const i=this._inBackground;this._inBackground=!a.some((e=>e.isIntersecting)),!this._inBackground&&this._lastMediaLoadedInfo&&e(this._lastMediaLoadedInfo.source,this._lastMediaLoadedInfo.mediaLoadedInfo),i!==this._inBackground&&this._host.requestUpdate()}}let E=class extends o{constructor(){super(...arguments),this.label="",this._isVideoMediaLoaded=!1,this._hasProviderError=!1,this._showStreamTroubleshooting=!1,this._refProvider=s(),this._lazyLoadController=null,this._importPromises=[]}async getMediaPlayerController(){return await this.updateComplete,await(this._refProvider.value?.getMediaPlayerController())??null}_getResolvedProvider(){return"auto"===this.cameraConfig?.live_provider?this.cameraConfig?.webrtc_card?.entity||this.cameraConfig?.webrtc_card?.url?"webrtc-card":this.cameraConfig?.camera_entity?"ha":this.cameraConfig?.frigate.camera_name?"jsmpeg":n.cameras.live_provider:this.cameraConfig?.live_provider||"image"}_shouldShowImageDuringLoading(){return!(this._isVideoMediaLoaded||!this.cameraConfig?.camera_entity||!this.hass||!this.liveConfig?.show_image_during_load||this._showStreamTroubleshooting||this._hasProviderError)}disconnectedCallback(){this._isVideoMediaLoaded=!1,super.disconnectedCallback()}_videoMediaShowHandler(){this._isVideoMediaLoaded=!0,this._showStreamTroubleshooting=!1}_providerErrorHandler(){this._hasProviderError=!0}willUpdate(e){if((e.has("liveConfig")||!this._lazyLoadController&&this.liveConfig)&&(this._lazyLoadController?.destroy(),this._lazyLoadController?.removeController(),this._lazyLoadController=new A(this,this.liveConfig?.lazy_load,this.liveConfig?.lazy_unload),this._lazyLoadController.addListener((e=>{e||(this._isVideoMediaLoaded=!1,d(this))}))),e.has("liveConfig")&&(this.liveConfig?.show_image_during_load&&this._importPromises.push(import("./image-8ebd2246.js")),this.liveConfig?.zoomable&&this._importPromises.push(import("./zoomer-db456961.js"))),e.has("cameraConfig")){const e=this._getResolvedProvider();"jsmpeg"===e?this._importPromises.push(import("./jsmpeg-0d0233a7.js")):"ha"===e?this._importPromises.push(import("./ha-d9c8474b.js")):"webrtc-card"===e?this._importPromises.push(import("./webrtc-card-1a2905aa.js")):"image"===e?this._importPromises.push(import("./image-8ebd2246.js")):"go2rtc"===e&&this._importPromises.push(import("./index-ea50d5a6.js")),b(this,this.cameraConfig?.dimensions?.layout),this.style.aspectRatio=c({ratio:this.cameraConfig?.dimensions?.aspect_ratio})}}async getUpdateComplete(){const e=await super.getUpdateComplete();return await Promise.all(this._importPromises),this._importPromises=[],e}_useZoomIfRequired(e){return this.liveConfig?.zoomable?l` <advanced-camera-card-zoomer
    ...
    `:this._renderCarousel()}static get styles(){return p(":host {\n  width: 100%;\n  height: 100%;\n  display: block;\n}\n\n@keyframes warning-pulse {\n  0% {\n    border: solid 2px var(--advanced-camera-card-triggered-color-1, rgba(0, 0, 0, 0));\n  }\n  50% {\n    border: solid 2px var(--advanced-camera-card-triggered-color-2, var(--warning-color));\n  }\n  100% {\n    border: solid 2px var(--advanced-camera-card-triggered-color-1, rgba(0, 0, 0, 0));\n  }\n}\nadvanced-camera-card-live-carousel[triggered] {\n  animation: warning-pulse 5s infinite;\n}\n\nadvanced-camera-card-live-carousel[selected] {\n  --advanced-camera-card-triggered-color-1: var(--primary-color);\n}")}};a([i({attribute:!1})],N.prototype,"hass",void 0),a([i({attribute:!1})],N.prototype,"viewManagerEpoch",void 0),a([i({attribute:!1})],N.prototype,"liveConfig",void 0),a([i({attribute:!1})],N.prototype,"cardWideConfig",void 0),a([i({attribute:!1})],N.prototype,"cameraManager",void 0),a([i({attribute:!1})],N.prototype,"microphoneState",void 0),a([i({attribute:!1})],N.prototype,"triggeredCameraIDs",void 0),N=a([r("advanced-camera-card-live-grid")],N);let z=class extends o{constructor(){super(...arguments),this._controller=new S(this)}render(){if(this.hass&&this.cameraManager)return l`
    ...
    `}static get styles(){return p(f)}};a([i({attribute:!1})],z.prototype,"hass",void 0),a([i({attribute:!1})],z.prototype,"viewManagerEpoch",void 0),a([i({attribute:!1})],z.prototype,"liveConfig",void 0),a([i({attribute:!1})],z.prototype,"cameraManager",void 0),a([i({attribute:!1})],z.prototype,"cardWideConfig",void 0),a([i({attribute:!1})],z.prototype,"microphoneState",void 0),a([i({attribute:!1})],z.prototype,"triggeredCameraIDs",void 0),z=a([r("advanced-camera-card-live")],z);export{z as AdvancedCameraCardLive};
