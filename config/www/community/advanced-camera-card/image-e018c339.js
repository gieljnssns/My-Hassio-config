import{a,cV as e,x as t,cZ as r,r as i,d4 as s,_ as n,n as o,t as c}from"./card-fb92bb2e.js";import"./image-updating-player-4ee7cc0f.js";let d=class extends a{constructor(){super(...arguments),this._refImage=e()}async getMediaPlayerController(){return await this.updateComplete,await(this._refImage.value?.getMediaPlayerController())??null}render(){if(this.hass&&this.cameraConfig)return t`
