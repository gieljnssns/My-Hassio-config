import{i as e,s as a,_ as t,n,t as i,a as s,x as o,e as r,l,r as c,b as d,c as m,d as u,p as h,f as _,g,h as b,j as p,k as v,C as f,m as $,o as y,q as w,u as S,v as x,w as M,y as I,z as k,A as O,B as C,D as z,E as A,F as N,G as T,H as B,I as E,J as P,K as H,L as V,M as L,N as K,O as U,P as j,Q as q,R as D,S as R,T as F,U as G,V as J,W as Q,X as W,Y as X,Z as Y,$ as Z,a0 as ee,a1 as ae,a2 as te,a3 as ne,a4 as ie,a5 as se,a6 as oe,a7 as re,a8 as le,a9 as ce,aa as de,ab as me,ac as ue,ad as he,ae as _e,af as ge,ag as be,ah as pe,ai as ve,aj as fe,ak as $e,al as ye,am as we,an as Se,ao as xe,ap as Me,aq as Ie,ar as ke,as as Oe,at as Ce,au as ze,av as Ae,aw as Ne,ax as Te,ay as Be,az as Ee,aA as Pe,aB as He,aC as Ve,aD as Le,aE as Ke,aF as Ue,aG as je,aH as qe,aI as De,aJ as Re,aK as Fe,aL as Ge,aM as Je,aN as Qe,aO as We,aP as Xe,aQ as Ye,aR as Ze,aS as ea,aT as aa,aU as ta,aV as na,aW as ia,aX as sa,aY as oa,aZ as ra,a_ as la,a$ as ca,b0 as da,b1 as ma,b2 as ua,b3 as ha,b4 as _a,b5 as ga,b6 as ba,b7 as pa,b8 as va,b9 as fa,ba as $a,bb as ya,bc as wa,bd as Sa,be as xa,bf as Ma,bg as Ia,bh as ka,bi as Oa,bj as Ca,bk as za,bl as Aa,bm as Na,bn as Ta,bo as Ba,bp as Ea,bq as Pa,br as Ha,bs as Va,bt as La,bu as Ka,bv as Ua,bw as ja,bx as qa,by as Da,bz as Ra,bA as Fa,bB as Ga,bC as Ja,bD as Qa,bE as Wa,bF as Xa,bG as Ya,bH as Za,bI as et,bJ as at,bK as tt,bL as nt,bM as it,bN as st,bO as ot,bP as rt,bQ as lt,bR as ct,bS as dt,bT as mt,bU as ut,bV as ht,bW as _t,bX as gt,bY as bt,bZ as pt,b_ as vt,b$ as ft,c0 as $t,c1 as yt,c2 as wt,c3 as St,c4 as xt,c5 as Mt,c6 as It,c7 as kt,c8 as Ot,c9 as Ct,ca as zt,cb as At,cc as Nt,cd as Tt,ce as Bt,cf as Et,cg as Pt,ch as Ht,ci as Vt,cj as Lt,ck as Kt,cl as Ut,cm as jt,cn as qt,co as Dt,cp as Rt,cq as Ft,cr as Gt,cs as Jt,ct as Qt,cu as Wt,cv as Xt,cw as Yt,cx as Zt,cy as en,cz as an,cA as tn,cB as nn,cC as sn,cD as on,cE as rn}from"./card-fe58fbb1.js";class ln{constructor(e){this._assigning=!1,this._value=null,this._blurEventHandler=()=>{this._setAssigning(!1)},this._keydownEventHandler=e=>{e.key&&!["Control","Alt","Shift","Meta"].includes(e.key)&&(this.setValue({key:e.key,ctrl:e.ctrlKey,alt:e.altKey,shift:e.shiftKey,meta:e.metaKey}),this._setAssigning(!1))},this._host=e,this._host.addController(this)}setValue(a){e(a,this._value)||(this._value=a,this._host.requestUpdate(),this._host.dispatchEvent(new CustomEvent("value-changed",{detail:{value:this._value}})))}getValue(){return this._value}hasValue(){return!!this._value}isAssigning(){return this._assigning}toggleAssigning(){this._setAssigning(!this._assigning)}_setAssigning(e){this._assigning=e,a(this._host,this._assigning,"assigning"),this._assigning?this._host.addEventListener("keydown",this._keydownEventHandler):this._host.removeEventListener("keydown",this._keydownEventHandler),this._host.requestUpdate()}hostConnected(){this._host.addEventListener("blur",this._blurEventHandler)}hostDisconnected(){this._host.removeEventListener("blur",this._blurEventHandler)}}let cn=class extends s{constructor(){super(...arguments),this._controller=new ln(this)}willUpdate(e){e.has("value")&&this._controller.setValue(this.value??null)}render(){if(!this.label)return;const e=e=>o`<div class="key">
    ...
    ></frigate-card-key-assigner>`}_renderViewKeyboardShortcutMenu(){return this._putInSubmenu("view.keyboard_shortcuts",!0,`config.${T}.editor_label`,"mdi:keyboard",o`
      ...
      `)}`}_renderMenuButton(e,a){const t=[{value:"",label:""},{value:"matching",label:l("config.menu.buttons.alignments.matching")},{value:"opposing",label:l("config.menu.buttons.alignments.opposing")}];return o` ${this._putInSubmenu("menu.buttons",e,`config.menu.buttons.${e}`,"mdi:gesture-tap-button",o`
        ...
        ${this._renderSwitch(`${D}.${e}.permanent`,this._defaults.menu.buttons[e]?.permanent??!1,{label:l("config.menu.buttons.permanent")})}
        ...
        ${a}
      `)}`}_putInSubmenu(e,a,t,n,i){const s=this._expandedMenus[e]===a,c={submenu:!0,selected:s},d=dt(n);return o` <div class="${r(c)}">
      <div
        ...
        .key=${a}
      >
        ${d?o` <img src=${d} /> `:o` <ha-icon .icon=${n}></ha-icon> `}
        <span>${l(t)}</span>
      </div>
      ${s?o`<div class="values">${i}</div>`:""}
    </div>`}_renderMediaLayout(e,a,t,n,i,s,r,c,d,m,u,h){return this._putInSubmenu(e,!0,a,"mdi:page-layout-body",o`
      ...
      ${this._renderSwitch(i,s,{label:l(`config.common.${W}`)})}
    `}_renderMiniTimeline(e,a,t,n,i,s,r,c,d){return this._putInSubmenu(e,!0,"config.common.controls.timeline.editor_label","mdi:chart-gantt",o` ${this._renderOptionSelector(a,this._miniTimelineModes,{label:l("config.common.controls.timeline.mode")})}
      ${this._renderTimelineCoreControls(t,n,i,s,r,c,d)}`)}_renderViewDisplay(e,a,t,n,i){return this._putInSubmenu(e,!0,"config.common.display.editor_label","mdi:palette-swatch",o`
      ...
      `)}_renderNextPreviousControls(e,a,t,n){return this._putInSubmenu(e,!0,"config.common.controls.next_previous.editor_label","mdi:arrow-right-bold-circle",o`
      ...
      `)}_renderThumbnailsControls(e,a,t,n,i,s,r,c){return this._putInSubmenu(e,!0,"config.common.controls.thumbnails.editor_label","mdi:image-text",o`
      ...
      <div class="${r(d)}">
        ...
        ${this._expandedMenus[dn]===a?o` <div class="values">
              ...
              ${this._putInSubmenu("cameras.engine",!0,"config.cameras.engines.editor_label","mdi:engine",o`${this._putInSubmenu("cameras.frigate",a,"config.cameras.frigate.editor_label","frigate",o`
                  ...
                  `)}
                ${this._putInSubmenu("cameras.motioneye",a,"config.cameras.motioneye.editor_label","motioneye",o`
                  ...
                  `)} `)}
              ${this._putInSubmenu("cameras.live_provider",!0,"config.cameras.live_provider_options.editor_label","mdi:cctv",o` ${this._putInSubmenu("cameras.go2rtc",a,"config.cameras.go2rtc.editor_label","mdi:alpha-g-circle",o`${this._renderOptionSelector(ae(kt,a),this._go2rtcModes,{multiple:!0,label:l("config.cameras.go2rtc.modes.editor_label")})}
                  ${this._renderStringInput(ae(Ot,a))}`)}
                ${this._putInSubmenu("cameras.image",!0,"config.cameras.image.editor_label","mdi:image",this._renderImageOptions(ae(Ct,a),ae(zt,a),ae(At,a),ae(Nt,a),ae(Tt,a)))}
                ${this._putInSubmenu("cameras.webrtc_card",a,"config.cameras.webrtc_card.editor_label","mdi:webrtc",o`${this._renderEntitySelector(ae(Bt,a),"camera")}
                  ${this._renderStringInput(ae(Et,a))}`)}`)}
              ${this._putInSubmenu("cameras.dependencies",a,"config.cameras.dependencies.editor_label","mdi:graph",o` ${this._renderSwitch(ae(Pt,a),this._defaults.cameras.dependencies.all_cameras)}
              ...
              ${this._putInSubmenu("cameras.dimensions",a,"config.cameras.dimensions.editor_label","mdi:aspect-ratio",o`
                  ...
                  ${this._renderMediaLayout("cameras.dimensions.layout","config.cameras.dimensions.layout.editor_label",ae(Ft,a),ae(Gt,a),ae(Jt,a),ae(Qt,a),ae(Wt,a),ae(Xt,a),ae(Yt,a),ae(Zt,a),ae(en,a),ae(an,a))}
                `)}
    ...
    `}_updateConfig(e){this._config=e,te(this,"config-changed",{config:this._config})}render(){if(!this.hass||!this._config)return o``;const e=x(this.hass),a=b(this._config,on)||[];return o`
      ${this._configUpgradeable?o` <div class="upgrade">
              ...
              <span>
                <mwc-button
                  ...
                  @click=${()=>{if(this._config){const e=m(this._config);ne(e),this._updateConfig(e)}}}
                >
                </mwc-button>
              </span>
            </div>
      ...
      <div class="card-config">
        ...
        ${"profiles"===this._expandedMenus[mn]?o` <div class="values">
              ${this._renderOptionSelector(ie,this._profiles,{multiple:!0,label:l("config.profiles.editor_label")})}
            </div>`:""}
        ...
        ${"live"===this._expandedMenus[mn]?o`
              <div class="values">
                ...
                ${this._putInSubmenu("live.controls",!0,"config.live.controls.editor_label","mdi:gamepad",o`
                    ...
                    ${this._renderThumbnailsControls("live.controls.thumbnails",He,Ve,Le,Ke,Ue,this._defaults.live.controls.thumbnails,{configPathMediaType:je,configPathEventsMediaType:qe,configPathMode:De})}
                    ${this._renderMiniTimeline("live.controls.timeline",Re,Fe,Ge,Je,Qe,We,this._defaults.live.controls.timeline.show_recordings,Xe)}
                    ${this._putInSubmenu("live.controls.ptz",!0,"config.live.controls.ptz.editor_label","mdi:pan",o`
                        ...
                        ${this._renderSwitch(na,this._defaults.live.controls.ptz.hide_home,{label:l("config.live.controls.ptz.hide_home")})}
                      `)}
                  `)}
                ${this._putInSubmenu("live.microphone",!0,"config.live.microphone.editor_label","mdi:microphone",o`
                    ${this._renderNumberInput(ia)}
        ...
        ${"media_viewer"===this._expandedMenus[mn]?o` <div class="values">
              ...
              ${this._putInSubmenu("media_viewer.controls",!0,"config.media_viewer.controls.editor_label","mdi:gamepad",o`
                  ...
                  ${this._renderMiniTimeline("media_viewer.controls.timeline",Ea,Pa,Ha,Va,La,Ka,this._defaults.media_viewer.controls.timeline.show_recordings,Ua)}
                `)}
            </div>`:""}
        ${this._renderOptionSetHeader("image")}
        ${"image"===this._expandedMenus[mn]?o` <div class="values">
              ${this._renderImageOptions(ja,qa,Da,Ra,Fa)}
            </div>`:""}
        ...
        ${"performance"===this._expandedMenus[mn]?o` <div class="values">
              ...
              ${this._putInSubmenu("performance.features",!0,"config.performance.features.editor_label","mdi:feature-search",o`
                  ...
                  ${this._renderNumberInput(nt,{max:it})}
