import{i as e,s as i,_ as t,n,t as a,a as s,x as o,e as r,l,r as c,b as d,c as u,d as m,p as h,f as _,g,h as b,j as p,k as v,C as f,m as $,o as y,q as w,u as S,v as x,w as M,y as I,z as k,A as O,B as C,D as z,E as A,F as N,G as T,H as B,I as E,J as P,K as H,L,M as V,N as K,O as U,P as j,Q as q,R,S as D,Z as F,T as G,U as J,V as Q,W,X,Y,$ as Z,a0 as ee,a1 as ie,a2 as te,a3 as ne,a4 as ae,a5 as se,a6 as oe,a7 as re,a8 as le,a9 as ce,aa as de,ab as ue,ac as me,ad as he,ae as _e,af as ge,ag as be,ah as pe,ai as ve,aj as fe,ak as $e,al as ye,am as we,an as Se,ao as xe,ap as Me,aq as Ie,ar as ke,as as Oe,at as Ce,au as ze,av as Ae,aw as Ne,ax as Te,ay as Be,az as Ee,aA as Pe,aB as He,aC as Le,aD as Ve,aE as Ke,aF as Ue,aG as je,aH as qe,aI as Re,aJ as De,aK as Fe,aL as Ge,aM as Je,aN as Qe,aO as We,aP as Xe,aQ as Ye,aR as Ze,aS as ei,aT as ii,aU as ti,aV as ni,aW as ai,aX as si,aY as oi,aZ as ri,a_ as li,a$ as ci,b0 as di,b1 as ui,b2 as mi,b3 as hi,b4 as _i,b5 as gi,b6 as bi,b7 as pi,b8 as vi,b9 as fi,ba as $i,bb as yi,bc as wi,bd as Si,be as xi,bf as Mi,bg as Ii,bh as ki,bi as Oi,bj as Ci,bk as zi,bl as Ai,bm as Ni,bn as Ti,bo as Bi,bp as Ei,bq as Pi,br as Hi,bs as Li,bt as Vi,bu as Ki,bv as Ui,bw as ji,bx as qi,by as Ri,bz as Di,bA as Fi,bB as Gi,bC as Ji,bD as Qi,bE as Wi,bF as Xi,bG as Yi,bH as Zi,bI as et,bJ as it,bK as tt,bL as nt,bM as at,bN as st,bO as ot,bP as rt,bQ as lt,bR as ct,bS as dt,bT as ut,bU as mt,bV as ht,bW as _t,bX as gt,bY as bt,bZ as pt,b_ as vt,b$ as ft,c0 as $t,c1 as yt,c2 as wt,c3 as St,c4 as xt,c5 as Mt,c6 as It,c7 as kt,c8 as Ot,c9 as Ct,ca as zt,cb as At,cc as Nt,cd as Tt,ce as Bt,cf as Et,cg as Pt,ch as Ht,ci as Lt,cj as Vt,ck as Kt,cl as Ut,cm as jt,cn as qt,co as Rt,cp as Dt,cq as Ft,cr as Gt,cs as Jt,ct as Qt,cu as Wt,cv as Xt,cw as Yt,cx as Zt,cy as en,cz as tn,cA as nn,cB as an,cC as sn,cD as on,cE as rn,cF as ln,cG as cn,cH as dn,cI as un,cJ as mn,cK as hn,cL as _n,cM as gn,cN as bn}from"./card-73ddfee6.js";class pn{constructor(e){this._assigning=!1,this._value=null,this._blurEventHandler=()=>{this._setAssigning(!1)},this._keydownEventHandler=e=>{e.key&&!["Control","Alt","Shift","Meta"].includes(e.key)&&(this.setValue({key:e.key,ctrl:e.ctrlKey,alt:e.altKey,shift:e.shiftKey,meta:e.metaKey}),this._setAssigning(!1))},this._host=e,this._host.addController(this)}setValue(i){e(i,this._value)||(this._value=i,this._host.requestUpdate(),this._host.dispatchEvent(new CustomEvent("value-changed",{detail:{value:this._value}})))}getValue(){return this._value}hasValue(){return!!this._value}isAssigning(){return this._assigning}toggleAssigning(){this._setAssigning(!this._assigning)}_setAssigning(e){this._assigning=e,i(this._host,this._assigning,"assigning"),this._assigning?this._host.addEventListener("keydown",this._keydownEventHandler):this._host.removeEventListener("keydown",this._keydownEventHandler),this._host.requestUpdate()}hostConnected(){this._host.addEventListener("blur",this._blurEventHandler)}hostDisconnected(){this._host.removeEventListener("blur",this._blurEventHandler)}}let vn=class extends s{constructor(){super(...arguments),this._controller=new pn(this)}willUpdate(e){e.has("value")&&this._controller.setValue(this.value??null)}render(){if(!this.label)return;const e=e=>o`<div class="key">
    ...
    `}_renderCamera(e,i,t,n){const a=[{value:"",label:""},{value:"auto",label:l("config.cameras.live_providers.auto")},{value:"ha",label:l("config.cameras.live_providers.ha")},{value:"image",label:l("config.cameras.live_providers.image")},{value:"jsmpeg",label:l("config.cameras.live_providers.jsmpeg")},{value:"go2rtc",label:l("config.cameras.live_providers.go2rtc")},{value:"webrtc-card",label:l("config.cameras.live_providers.webrtc-card")}],s=[];e.forEach(((e,t)=>{t!==i&&s.push({value:te(e),label:this._getEditorCameraTitle(t,e)})}));const c=e=>{if(this._config){const i=u(this._config);e(i)&&this._updateConfig(i)}},d={submenu:!0,selected:this._expandedMenus[fn]===i};return o`
      <div class="${r(d)}">
        ...
        ${this._expandedMenus[fn]===i?o` <div class="values">
              <div class="controls">
                <ha-icon-button
                  .label=${l("editor.move_up")}
                  .disabled=${n||!this._config||!Array.isArray(this._config.cameras)||i<=0}
                  @click=${()=>!n&&c((e=>!!(Array.isArray(e.cameras)&&i>0)&&(_t(e.cameras,i,i-1),this._openMenu(fn,i-1),!0)))}
                >
                  <frigate-card-icon
                ...
                <ha-icon-button
                  ...
                  @click=${()=>!n&&c((e=>!!(Array.isArray(e.cameras)&&i<e.cameras.length-1)&&(_t(e.cameras,i,i+1),this._openMenu(fn,i+1),!0)))}
                >
                  <frigate-card-icon
                ...
                <ha-icon-button
                  ...
                  .disabled=${n}
                  @click=${()=>{c((e=>!!Array.isArray(e.cameras)&&(e.cameras.splice(i,1),this._closeMenu(fn),!0)))}}
                >
              ...
              ${this._putInSubmenu("cameras.engine",!0,"config.cameras.engines.editor_label","mdi:engine",o`${this._putInSubmenu("cameras.frigate",i,"config.cameras.frigate.editor_label","frigate",o`
                    ${this._renderStringInput(ne($t,i))}
                    ${this._renderStringInput(ne(yt,i))}
                    ${this._renderOptionSelector(ne(wt,i),[],{multiple:!0,label:l("config.cameras.frigate.labels")})}
                    ${this._renderOptionSelector(ne(St,i),[],{multiple:!0,label:l("config.cameras.frigate.zones")})}
                    ${this._renderStringInput(ne(xt,i))}
                  `)}
                ${this._putInSubmenu("cameras.motioneye",i,"config.cameras.motioneye.editor_label","motioneye",o` ${this._renderStringInput(ne(Mt,i))}
                ...
                ${this._putInSubmenu("cameras.reolink",i,"config.cameras.reolink.editor_label","reolink",o` ${this._renderStringInput(ne(zt,i))}
                  ${this._renderOptionSelector(ne(At,i),this._reolinkMediaResolution,{label:l("config.cameras.reolink.media_resolution.editor_label")})}`)}`)}
              ${this._putInSubmenu("cameras.live_provider",!0,"config.cameras.live_provider_options.editor_label","mdi:cctv",o` ${this._putInSubmenu("cameras.go2rtc",i,"config.cameras.go2rtc.editor_label","mdi:alpha-g-circle",o`${this._renderOptionSelector(ne(Nt,i),this._go2rtcModes,{multiple:!0,label:l("config.cameras.go2rtc.modes.editor_label")})}
                  ${this._renderStringInput(ne(Tt,i))}`)}
                ${this._putInSubmenu("cameras.image",!0,"config.cameras.image.editor_label","mdi:image",this._renderImageOptions(ne(Bt,i),ne(Et,i),ne(Pt,i),ne(Ht,i),ne(Lt,i)))}
                ${this._putInSubmenu("cameras.webrtc_card",i,"config.cameras.webrtc_card.editor_label","mdi:webrtc",o`${this._renderEntitySelector(ne(Vt,i),"camera")}
                  ${this._renderStringInput(ne(Kt,i))}`)}`)}
              ${this._putInSubmenu("cameras.dependencies",i,"config.cameras.dependencies.editor_label","mdi:graph",o` ${this._renderSwitch(ne(Ut,i),this._defaults.cameras.dependencies.all_cameras)}
              ...
              ${this._putInSubmenu("cameras.triggers",i,"config.cameras.triggers.editor_label","mdi:magnify-scan",o`
                  ...
                  ${this._renderSwitch(ne(Rt,i),this._defaults.cameras.triggers.motion)}
                  ${this._renderOptionSelector(ne(Dt,i),t,{multiple:!0})}
                  ${this._renderOptionSelector(ne(Ft,i),this._triggersEvents,{multiple:!0,label:l("config.cameras.triggers.events.editor_label")})}
                `)}
              ${this._putInSubmenu("cameras.cast",i,"config.cameras.cast.editor_label","mdi:cast",o`
                  ${this._renderOptionSelector(ne(Gt,i),this._castMethods)}
              ...
              ${this._putInSubmenu("cameras.dimensions",i,"config.cameras.dimensions.editor_label","mdi:aspect-ratio",o`
                  ...
                  ${this._renderMediaLayout("cameras.dimensions.layout","config.cameras.dimensions.layout.editor_label",ne(Xt,i),ne(Yt,i),ne(Zt,i),ne(en,i),ne(tn,i),ne(nn,i),ne(an,i),ne(sn,i),ne(on,i),ne(rn,i))}
                `)}
              ${this._putInSubmenu("cameras.capabilities",i,"config.cameras.capabilities.editor_label","mdi:cog-stop",o`
                  ${this._renderOptionSelector(ne(ln,i),this._capabilities,{multiple:!0})}
              ...
              ${this._putInSubmenu("cameras.proxy",i,"config.cameras.proxy.editor_label","mdi:arrow-decision",o`
                  ${this._renderOptionSelector(ne(dn,i),this._proxyMedia,{label:l("config.cameras.proxy.media.editor_label")})}
                  ${this._renderSwitch(ne(un,i),this._defaults.cameras.proxy.dynamic)}
                  ${this._renderOptionSelector(ne(mn,i),this._proxySSLVerification,{label:l("config.cameras.proxy.ssl_verification.editor_label")})}
                  ${this._renderOptionSelector(ne(hn,i),this._proxySSLCiphers,{label:l("config.cameras.proxy.ssl_ciphers.editor_label")})}
                `)}
            </div>`:""}
      </div>
    ...
    `}_updateConfig(e){this._config=e,ae(this,"config-changed",{config:this._config})}render(){if(!this.hass||!this._config)return o``;const e=x(this.hass),i=b(this._config,gn)||[];return o`
      ...
      <div class="card-config">
        ...
        ${"cameras"===this._expandedMenus[$n]?o`
              <div class="values">
        ...
        ${"profiles"===this._expandedMenus[$n]?o` <div class="values">
        ...
        ${"status_bar"===this._expandedMenus[$n]?o`
              <div class="values">
        ...
        ${"media_gallery"===this._expandedMenus[$n]?o` <div class="values">
        ...
        ${"media_viewer"===this._expandedMenus[$n]?o` <div class="values">
        ...
        ${"image"===this._expandedMenus[$n]?o` <div class="values">
              ${this._renderImageOptions(Di,Fi,Gi,Ji,Qi)}
            </div>`:""}
        ${this._renderOptionSetHeader("timeline")}
        ${"timeline"===this._expandedMenus[$n]?o` <div class="values">
        ...
        ${"dimensions"===this._expandedMenus[$n]?o` <div class="values">
              ${this._renderOptionSelector(tt,this._aspectRatioModes)}
              ${this._renderStringInput(nt)}
              ${this._renderStringInput(at)}
            </div>`:""}
        ${this._renderOptionSetHeader("performance","low"===b(this._config,bn)?"warning":void 0)}
        ${"performance"===this._expandedMenus[$n]?o` <div class="values">
              ${"low"===b(this._config,bn)?this._renderInfo(l("config.performance.warning")):o``}
