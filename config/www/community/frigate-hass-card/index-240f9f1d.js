import{cO as e,_ as i,n as t,b as a,t as r,a as o,cP as s,cL as n,cQ as d,cR as g,x as c,cS as h,l,cT as m,e as v,r as p,cU as u,cV as C,cW as f,cX as I,cY as M,cZ as _,c_ as w,c$ as b,d0 as y,d1 as L}from"./card-73ddfee6.js";import{u as A,i as j}from"./media-layout-83a21d30.js";import{p as D,d as $,M as S,A as E,a as N,b as z}from"./media-9ee30a36.js";class k{constructor(e){this._inBackground=!1,this._lastMediaLoadedInfo=null,this._handleMediaLoaded=e=>{this._lastMediaLoadedInfo={source:e.composedPath()[0],mediaLoadedInfo:e.detail},this._inBackground&&e.stopPropagation()},this._host=e,e.addController(this),this._intersectionObserver=new IntersectionObserver(this._intersectionHandler.bind(this))}hostConnected(){this._intersectionObserver.observe(this._host),this._host.addEventListener("frigate-card:media:loaded",this._handleMediaLoaded)}hostDisconnected(){this._intersectionObserver.disconnect(),this._host.removeEventListener("frigate-card:media:loaded",this._handleMediaLoaded)}isInBackground(){return this._inBackground}_intersectionHandler(i){const t=this._inBackground;this._inBackground=!i.some((e=>e.isIntersecting)),!this._inBackground&&this._lastMediaLoadedInfo&&e(this._lastMediaLoadedInfo.source,this._lastMediaLoadedInfo.mediaLoadedInfo),t!==this._inBackground&&this._host.requestUpdate()}}let T=class extends o{constructor(){super(...arguments),this.load=!1,this.label="",this._isVideoMediaLoaded=!1,this._hasProviderError=!1,this._refProvider=s(),this._importPromises=[]}async play(){await this.updateComplete,await(this._refProvider.value?.updateComplete),await D(this,this._refProvider.value)}async pause(){await this.updateComplete,await(this._refProvider.value?.updateComplete),await(this._refProvider.value?.pause())}async mute(){await this.updateComplete,await(this._refProvider.value?.updateComplete),await(this._refProvider.value?.mute())}async unmute(){await this.updateComplete,await(this._refProvider.value?.updateComplete),await(this._refProvider.value?.unmute())}isMuted(){return this._refProvider.value?.isMuted()??!0}async seek(e){await this.updateComplete,await(this._refProvider.value?.updateComplete),await(this._refProvider.value?.seek(e))}async setControls(e){await this.updateComplete,await(this._refProvider.value?.updateComplete),await(this._refProvider.value?.setControls(e))}isPaused(){return this._refProvider.value?.isPaused()??!0}async getScreenshotURL(){return await this.updateComplete,await(this._refProvider.value?.updateComplete),await(this._refProvider.value?.getScreenshotURL())??null}_getResolvedProvider(){return"auto"===this.cameraConfig?.live_provider?this.cameraConfig?.webrtc_card?.entity||this.cameraConfig?.webrtc_card?.url?"webrtc-card":this.cameraConfig?.camera_entity?"ha":this.cameraConfig?.frigate.camera_name?"jsmpeg":n.cameras.live_provider:this.cameraConfig?.live_provider||"image"}_shouldShowImageDuringLoading(){return!(!this.cameraConfig?.camera_entity||!this.hass||!this.liveConfig?.show_image_during_load||this._hasProviderError)}disconnectedCallback(){this._isVideoMediaLoaded=!1}_videoMediaShowHandler(){this._isVideoMediaLoaded=!0}_providerErrorHandler(){this._hasProviderError=!0}willUpdate(e){if(e.has("load")&&(this.load||(this._isVideoMediaLoaded=!1,d(this))),e.has("liveConfig")&&(this.liveConfig?.show_image_during_load&&this._importPromises.push(import("./image-644df26c.js")),this.liveConfig?.zoomable&&this._importPromises.push(import("./zoomer-d884f811.js"))),e.has("cameraConfig")){const e=this._getResolvedProvider();"jsmpeg"===e?this._importPromises.push(import("./jsmpeg-8dcf1563.js")):"ha"===e?this._importPromises.push(import("./ha-e68212c3.js")):"webrtc-card"===e?this._importPromises.push(import("./webrtc-card-e254368c.js")):"image"===e?this._importPromises.push(import("./image-644df26c.js")):"go2rtc"===e&&this._importPromises.push(import("./index-b9466376.js")),A(this,this.cameraConfig?.dimensions?.layout),this.style.aspectRatio=g({ratio:this.cameraConfig?.dimensions?.aspect_ratio})}}async getUpdateComplete(){const e=await super.getUpdateComplete();return await Promise.all(this._importPromises),this._importPromises=[],e}_useZoomIfRequired(e){return this.liveConfig?.zoomable?c` <frigate-card-zoomer
    ...
    `}_getSubstreamCameraID(e,i){return i?.context?.live?.overrides?.get(e)??e}_getCameraNeighbors(){const e=this.cameraManager?[...this.cameraManager?.getStore().getCameraIDsWithCapability("live")]:[],i=this.viewManagerEpoch?.manager.getView();if(this.viewFilterCameraID||e.length<=1||!i||!this.hass)return{};const t=this.viewFilterCameraID??i.camera,a=e.indexOf(t);if(a<0)return{};const r=e[a>0?a-1:e.length-1],o=e[a+1<e.length?a+1:0];return{previous:{id:r,metadata:r?this.cameraManager?.getCameraMetadata(this._getSubstreamCameraID(r,i)):null},next:{id:o,metadata:o?this.cameraManager?.getCameraMetadata(this._getSubstreamCameraID(o,i)):null}}}_renderNextPrevious(e,i){const t=_(this),a="ltr"===t&&"left"===e||"rtl"===t&&"right"===e?i?.previous:i?.next;return c`<frigate-card-next-previous-control
      ...
      ?disabled=${!a}
      @click=${e=>{this._setViewCameraID(a?.id),w(e)}}
    >
      ...
      <frigate-card-carousel
        ...
        .plugins=${j([this.cameraManager,this.overriddenLiveConfig],this._getPlugins.bind(this))}
    ...
    `}_setMediaTarget(){const e=this.viewManagerEpoch?.manager.getView(),i=this._getSelectedCameraIndex();this.viewFilterCameraID?this._mediaActionsController.setTarget(i,e?.camera===this.viewFilterCameraID):this._mediaActionsController.setTarget(i,!0)}updated(e){super.updated(e);let i=!1;!this._mediaActionsController.hasRoot()&&this._refCarousel.value&&(this._mediaActionsController.initialize(this._refCarousel.value),i=!0),(i||e.has("viewManagerEpoch"))&&this._setMediaTarget()}static get styles(){return p(":host {\n  display: block;\n  --video-max-height: none;\n}\n\n:host(:not([grid-id])) {\n  height: 100%;\n}\n\n:host([unselected]) frigate-card-carousel {\n  pointer-events: none;\n}\n\n.embla__slide {\n  display: flex;\n  justify-content: center;\n  height: 100%;\n  flex: 0 0 100%;\n}")}};i([t({attribute:!1})],P.prototype,"hass",void 0),i([t({attribute:!1})],P.prototype,"viewManagerEpoch",void 0),i([t({attribute:!1})],P.prototype,"nonOverriddenLiveConfig",void 0),i([t({attribute:!1})],P.prototype,"overriddenLiveConfig",void 0),i([t({attribute:!1,hasChanged:u})],P.prototype,"overrides",void 0),i([t({attribute:!1})],P.prototype,"conditionsManagerEpoch",void 0),i([t({attribute:!1})],P.prototype,"cardWideConfig",void 0),i([t({attribute:!1})],P.prototype,"cameraManager",void 0),i([t({attribute:!1})],P.prototype,"microphoneState",void 0),i([t({attribute:!1})],P.prototype,"viewFilterCameraID",void 0),i([a()],P.prototype,"_mediaHasLoaded",void 0),P=i([r("frigate-card-live-carousel")],P);let x=class extends o{_renderCarousel(e){const i=this.viewManagerEpoch?.manager.getView(),t=e??i?.camera;return c`
    ...
    `}_gridSelectCamera(e){this.viewManagerEpoch?.manager.setViewByParameters({params:{camera:e}})}_needsGrid(){const e=this.cameraManager?.getStore().getCameraIDsWithCapability("live"),i=this.viewManagerEpoch?.manager.getView();return!!i?.isGrid()&&!!i?.supportsMultipleDisplayModes()&&!!e&&e.size>1}willUpdate(e){e.has("viewManagerEpoch")&&this._needsGrid()&&import("./media-grid-6cf0aac1.js")}render(){if(!this.conditionsManagerEpoch||!this.nonOverriddenLiveConfig)return;const e=this.cameraManager?.getStore().getCameraIDsWithCapability("live");return e?.size&&this._needsGrid()?c`
    ...
    `}static get styles(){return p(L)}};i([t({attribute:!1})],Z.prototype,"conditionsManagerEpoch",void 0),i([t({attribute:!1})],Z.prototype,"hass",void 0),i([t({attribute:!1})],Z.prototype,"viewManagerEpoch",void 0),i([t({attribute:!1})],Z.prototype,"nonOverriddenLiveConfig",void 0),i([t({attribute:!1})],Z.prototype,"overriddenLiveConfig",void 0),i([t({attribute:!1,hasChanged:u})],Z.prototype,"overrides",void 0),i([t({attribute:!1})],Z.prototype,"cameraManager",void 0),i([t({attribute:!1})],Z.prototype,"cardWideConfig",void 0),i([t({attribute:!1})],Z.prototype,"microphoneState",void 0),i([t({attribute:!1})],Z.prototype,"triggeredCameraIDs",void 0),Z=i([r("frigate-card-live")],Z);export{Z as FrigateCardLive};
